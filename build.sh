...
sed "s/include({{body\.html}})/include({{listpancake}})/g;/\.txt {/a\    font-weight: bold\;" $maindir/builder/page_header.html | cat - $maindir/builder/footer.html | m4 > list-premini.html
